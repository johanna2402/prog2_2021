...
public class Spieler {
	...
	public boolean wuerfeln() {
		...
		while(!ende) {
			...
			if(wurf==6) {
				this.aktStand=0;
				System.out.printf("Versuch zu Ende %n Aktueller Spielstand von %s : %d Punkte % Der Naechste Spieler ist dran", this.name, this.aktStand);
				ende=true;
			}
			...
			int dialogResult = JOptionPane.showConfirmDialog(null, this.name + "wollen sie weiter wuerfeln?", "Weiter?", JOptionPane.YES_NO_OPTION);
